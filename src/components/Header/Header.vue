    ...
    <b-nav class="ml-auto">
      <b-nav-item-dropdown
        ...
        <template slot="button-content">
          ...
          <span class="small">admin--管理员</span>   
        </template>
      </b-nav-item-dropdown>
      <b-nav-item-dropdown id="v-step-2" class="settingsDropdown d-sm-down-none" no-caret right>
        ...
        <b-dropdown-item><i class="la la-user" />个人中心</b-dropdown-item>
        <b-dropdown-divider />
        <b-dropdown-item>
          <i class="la la-sign-out" />通知 &nbsp;&nbsp;<b-badge variant="danger" pill class="animate__animated animate__bounceIn">9</b-badge>
        </b-dropdown-item>
        <b-dropdown-divider />
        <b-dropdown-item-button @click="logout">
          <i class="la la-sign-out" />退出
